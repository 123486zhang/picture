...
public class jdongwu extends AppCompatActivity implements View.OnClickListener {
    ...
    private int[] photos = {R.drawable.changjinglu, R.drawable.daxiang, R.drawable.daxiongmao,
            ...
            R.drawable.huli,R.drawable.qie,R.drawable.tuoniao,R.drawable.tuzi,R.drawable.woniu
            ,R.drawable.wugui,R.drawable.xia,R.drawable.luotuo};
        ...
        public void run() {
            {
                ...
                switch (photoIndex) {
                    ...
                    case 3: {//如果没有歌
                        dongwu.setImageResource(photos[photoIndex]);
                        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.ch_gezi);
                        mediaPlayer.start();
                        try {
                            Thread.sleep(1000);
                        } catch (Exception e) {
                        }
                        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.en_gezhi);
                        mediaPlayer.start();
                        photoIndex = 4;
                        break;
                    }
                    case 4: {//如果没有歌
                        dongwu.setImageResource(photos[photoIndex]);
                        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.ch_hou);
                        mediaPlayer.start();
                        try {
                            Thread.sleep(1000);
                        } catch (Exception e) {
                        }
                        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.en_hou);
                        mediaPlayer.start();
                        photoIndex = 5;
                        break;
                    }
                    ...
                    case 6: {//如果没有歌
                        dongwu.setImageResource(photos[photoIndex]);
                        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.ch_qie);
                        mediaPlayer.start();
                        try {
                            Thread.sleep(1000);
                        } catch (Exception e) {
                        }
                        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.en_qie);
                        mediaPlayer.start();
                        photoIndex = 7;
                        break;
                    }
                    case 7: {//如果没有歌
                        dongwu.setImageResource(photos[photoIndex]);
                        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.ch_tuoniao);
                        mediaPlayer.start();
                        try {
                            Thread.sleep(1000);
                        } catch (Exception e) {
                        }
                        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.en_tuoniao);
                        mediaPlayer.start();
                        photoIndex = 8;
                        break;
                    }
                    ...
                    case 9: {//如果没有歌
                        dongwu.setImageResource(photos[photoIndex]);
                        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.ch_woniu);
                        mediaPlayer.start();
                        try {
                            Thread.sleep(1000);
                        } catch (Exception e) {
                        }
                        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.en_woniu);
                        mediaPlayer.start();
                        photoIndex = 10;
                        break;
                    }
                    ...
                    case 11: {//如果没有歌
                        dongwu.setImageResource(photos[photoIndex]);
                        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.ch_xia);
                        mediaPlayer.start();
                        try {
                            Thread.sleep(1000);
                        } catch (Exception e) {
                        }
                        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.en_xia);
                        mediaPlayer.start();
                        photoIndex = 12;
                        break;
                    }
                    case 12: {//如果没有歌
                        dongwu.setImageResource(photos[photoIndex]);
                        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.ch_luotuo);
                        mediaPlayer.start();
                        try {
                            Thread.sleep(1000);
                        } catch (Exception e) {
                        }
                        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.en_luotuo);
                        mediaPlayer.start();
                        photoIndex = 0;
                        break;
                    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dongwu = findViewById(R.id.dongwu);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.en:
                ...
                if(photoIndex == 3){//如果没有歌
                    mediaPlayer = MediaPlayer.create(this, R.raw.en_gezhi);
                    mediaPlayer.start();
                }
                if(photoIndex == 4){//如果没有歌
                    mediaPlayer = MediaPlayer.create(this, R.raw.en_hou);
                    mediaPlayer.start();
                }
                if(photoIndex == 5){//如果没有歌
                ...
                if(photoIndex == 6){//如果没有歌
                    mediaPlayer = MediaPlayer.create(this, R.raw.en_qie);
                    mediaPlayer.start();
                }
                if(photoIndex == 7){//如果没有歌
                    mediaPlayer = MediaPlayer.create(this, R.raw.en_tuoniao);
                    mediaPlayer.start();
                }
                if(photoIndex == 8){//如果没有歌
                ...
                if(photoIndex == 9){//如果没有歌
                    mediaPlayer = MediaPlayer.create(this, R.raw.en_woniu);
                    mediaPlayer.start();
                }
                if(photoIndex == 10){//如果没有歌
                ...
                if(photoIndex == 11){//如果没有歌
                    mediaPlayer = MediaPlayer.create(this, R.raw.en_xia);
                    mediaPlayer.start();
                }
                if(photoIndex == 12){//如果没有歌
                    mediaPlayer = MediaPlayer.create(this, R.raw.en_luotuo);
                    mediaPlayer.start();
                }
