...
public class jgametesten extends AppCompatActivity implements View.OnClickListener {
    ...
    private int[] photos = {R.drawable.changjinglu, R.drawable.daxiang, R.drawable.daxiongmao,
            ...
            ,R.drawable.xiaofangche,R.drawable.hongse, R.drawable.chengse, R.drawable.huangse,
